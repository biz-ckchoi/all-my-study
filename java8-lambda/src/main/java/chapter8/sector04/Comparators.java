...
public class Comparators {
    ...
    public static void main(String[] args) {
        ...
        Arrays.sort(presidents, Comparator.comparing(Person::getLastName).thenComparing(Person::getFirstName));
        System.out.println(Arrays.toString(presidents));

        Arrays.sort(presidents, Comparator.comparing(Person::getName, (s, t) -> Integer.compare(s.length(), t.length())));
        System.out.println(Arrays.toString(presidents));

        Arrays.sort(presidents, Comparator.comparingInt(p -> p.getName().length()));
        System.out.println(Arrays.toString(presidents));

        Arrays.sort(presidents, Comparator.comparing(Person::getMiddleName, Comparator.nullsFirst(Comparator.naturalOrder())));
        System.out.println(Arrays.toString(presidents));

        Arrays.sort(presidents, Comparator.comparing(Person::getMiddleName, Comparator.nullsFirst(Comparator.<String>naturalOrder().reversed())));
        System.out.println(Arrays.toString(presidents));
