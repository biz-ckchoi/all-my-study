...
public class MathematicalFunctions {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("1: " + 100000 * 100000);
        try {
            System.out.println("2: " + Math.multiplyExact(100000, 100000));
        ...
        for (int tries = 1; tries < 1000000000; tries++) {
            ...
            if (r == 1.0) {
                System.out.println("It happend at try " + tries);
                r = Math.nextDown(r);
