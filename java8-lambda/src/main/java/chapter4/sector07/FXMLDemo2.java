    ...
    public void start(Stage stage) {
        try {
            ...
            okButton.disableProperty().bind(
                    Bindings.createBooleanBinding(() -> username.getText().length() == 0 || password.getText().length() == 0, username.textProperty(), password.textProperty()));

            /*
            okButton.disableProperty().bind(Bindings.or(Bindings.isEmpty(username.textProperty()), Bindings.isEmpty(password.textProperty())));
            */
