...
public class TryWithResources {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            try (Scanner in = new Scanner(Paths.get("/usr/share/dict/words")); PrintWriter out = new PrintWriter("/Users/mbp088/Downloads/out.txt")) {
                while (in.hasNext()) {
                    out.println(in.next().toLowerCase());
                }
            }

        } catch (IOException ex) {  // Seperate try-with-resources from try/catch
            ex.printStackTrace();
        }
        ...
        try {
            ...
            System.out.println("se1:" + Arrays.toString(secondaryExceptions));
        }
        ...
        try {
            ...
            Throwable[] secondaryExceptions = ex.getSuppressed();
            System.out.println("se2:" + Arrays.toString(secondaryExceptions));
        }
