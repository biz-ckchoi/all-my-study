...
public class SimpleTreeTest {
    ...
    public void createSampleTree() {
        ...
        final SimpleTree<Integer> t3 = new SimpleTree<>(3, t1, t5);
    ...
    @Test
    public void search() {
        Assert.assertTrue(root.search(7));
        Assert.assertFalse(root.search(70));
    }
    ...
    public void insert() {
        ...
        Assert.assertEquals(Integer.valueOf(10), root.getRight().getRight().getValue());
    }
